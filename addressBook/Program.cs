    ...
    */
    ...
    static void Main(string[] args)
    {
        ...
        addressBook.AddContact(juan);
            ...
            Console.WriteLine("error adding contact.");
        }
        ...
        {
            Console.WriteLine("contact with the same email is already added");
        ...
        {   
            ...
            {
                Console.WriteLine("email/contact may not exist address book  ");
            }
        }
    }
}
